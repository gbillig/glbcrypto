...
int main(void) {
	...
	*/
	...
	key = (uint8_t[32]) {
		0x29, 0x09, 0x78, 0x06, 0xfe, 0x2a, 0x77, 0x87, 0x15, 0xc4, 0xec, 0xb5, 0x1c, 0xdc, 0xbf, 0x78,
		0xa7, 0x71, 0x58, 0x35, 0x67, 0x77, 0xe8, 0xea, 0xd4, 0x98, 0x24, 0x2a, 0x5d, 0x1a, 0xe2, 0x67
	};

	key_size = 32;

	iv = (uint8_t[16]) {
		0x65, 0x3d, 0x91, 0xef, 0xd1, 0xb9, 0x64, 0x6f, 0x98, 0xf3, 0xac, 0x26, 0x48, 0xfe, 0xb2, 0x74
	};

	plaintext = (uint8_t[48]) {
		0x00, 0x00, 0x00, 0x04, 0x00, 0x66, 0x00, 0x62, 0x00, 0x00, 0x00, 0x04, 0x00, 0x67, 0x00, 0x62,
		0x00, 0x00, 0x00, 0x04, 0x00, 0x70, 0x00, 0x77, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x6e, 0x00, 0x6f,
		0x00, 0x74, 0x00, 0x65, 0x00, 0x73, 0x0a, 0x0a, 0x0a, 0x0a, 0x0a, 0x0a, 0x0a, 0x0a, 0x0a, 0x0a
	};

	ciphertext = malloc(sizeof(uint8_t) * 48);
